...
1_You can see a main element with a corresponding 
id="main-doc", which contains the page's main content 
(technical documentation)

2_Within the #main-doc element, 
you can see several section elements, 
each with a class of main-section. 
There should be a minimum of five

3_The first element within each .main-section 
...
5_The .main-section elements should contain at least 
ten p elements total (not each)
